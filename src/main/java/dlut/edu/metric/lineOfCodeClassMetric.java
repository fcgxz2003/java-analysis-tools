...
public class lineOfCodeClassMetric extends AbstractJavaRule {

    //度量项名
    private final String name = "类的代码的行数";
    //精度
    ...
    public Object visit(ASTClassOrInterfaceDeclaration COID, Object data) {
        ...
        //度量名称
        String calculatorID = "lineOfCodeClassMetric";
        //得到监控的数值
        int num_monitor = (int) JavaMetrics.get(JavaClassMetricKey.LOC, COID);
        //起始行数
